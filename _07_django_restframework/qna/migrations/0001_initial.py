# Generated by Django 5.2.17 on 2026-09-11 03:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('voters', models.ManyToManyField(blank=True, related_name='question_votes', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Answer',
            fields=[
                ...
                ('voters', models.ManyToManyField(blank=True, related_name='answer_votes', to=settings.AUTH_USER_MODEL)),
